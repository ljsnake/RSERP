...
$(document).ready(function(){
	$("#subcontractorname").blur(function(){
		...
		if(name==$('#subcontractornameold').val()){
			$('#isnameok').val('1');
			return;
		}
		$.ajax({
			...
			<div class="content-pages-wrap">
				...
				<table width="100%" align="center" cellpadding="0" cellspacing="1" class="commonTable">
					<tr>
						...
						<td width="65%">
							<s:property value="subcontractor.id"/><input type="hidden" name="subcontractor.id" value="<s:property value="subcontractor.id"/>"/>
						</td>
					</tr>
					<tr>
						<td align="right">
						...
						<td >
							<input type="text" id="subcontractorname" name="subcontractor.name" size="20" value="<s:property value="subcontractor.name"/>" maxlength="20" onkeyup="checkCharacter(this);"/>
							<span id="namespan"></span><input type="hidden" id="isnameok" value="1"/>
							<input type="hidden" id="subcontractornameold" value="<s:property value="subcontractor.name"/>"/>
						</td>
					</tr>
				</table>
			</div>
